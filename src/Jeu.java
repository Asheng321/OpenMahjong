 ...
 *
 * Classe reporsentant un jeu de tuiles compos� de figures
 * 
...
public class Jeu {
	 ...
	 * renvoie la position absolue de la tuile (-1 si pas d'emplacement trouv�)
	 */
	public int ajouteTuile(Tuile t){
		int index=0;
		
		if((index=aTuile(t))<0){ //le joueur ne possede pas d�j� cette tuile
			index=0;
			while(figures[index].nbTuile>0 && index<13){	//cherche la premi�re figure libre
				index++;
			}
	...
	/**
	 * retourne le numero de la premi�re figure dont le nombre
	 * de tuile est �gale � nb. -1 s'il n'y en a pas
	 */
	...
	/**
	 * fonction qui retourne true si le jeu poss�de au moins une tuile
	 * de type dragon/vent
	 */
...
//					|| (figures[i].couleur()<figures[i+1].couleur()) 	// ou couleur sup�rieure � la suivante 
//					|| (figures[i].couleur()==figures[i+1].couleur() && figures[i].chiffre()<figures[i+1].chiffre())) 	// ou couleur identique et chiffre sup�rieur
	...
	/*
	 * retourne la couleur de la premi�re tuile trouv�e (non honneur)
...
//		}
	...
	/* retourne true si le jeu n'est compos� que de Pung/Kong de tuiles 
	 * majeures (1/9 rond/bambou/caract�re)*/
	...
	/**
	 * retourne le nombre de figure correspondant au chiffre et � la couleur demand�s
	 */
	 ...
	 * 	- 6 paires de chaque s�rie
	 *  - 1 paire du dragon associ� � la s�rie
	 */
	...
	/**
	 * Test le Mahjong special "Les 7 muses du po�te chinois":
	...
	/**
	 * Test le Mahjong special "Le triangle �ternel":
	 * 	- 4 paires de vent
	 *  - 3 paires de dragon 
	 */
	...
	/**
	 * Test le Mahjong special "La temp�te":
	 * 	- 2 pung de dragons
	 *  - 1 paire de chaque vent 
	 */
	 ...
	 * 	- 1 pung de 3 caract�re et 2 pung de nb pairs caract�re
	 *  - 1 pung de dragon rouge
	 *  - 1 paire de nb pair caract�re
	 */
	 ...
	 * 	- 1 pung de n�2, n�4, n�6 caract�re
	 *  - 1 pung de dragon rouge
	 *  - 1 paire de n�1 caract�re
	 */
	 ...
	 * 	- 1 pung de n�1, n�5, n�7, n�9 caract�re
	 *  - 1 dragon rouge
	 *  - 1 dragon blanc
	 */
	...
	/**
	 * Test le Mahjong special "Le mahjong imp�rial":
