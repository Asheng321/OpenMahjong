 ...
 *
 * Classe permettant de reportorier les tuiles jet�es
 * 
...
public class Discard {
	...
	int tableau[][] = new int[9][6];		// tableau pour compter les tuiles jet�es (9 num�ros sur 6 couleurs)
	JLabel[] cptTuile = new JLabel[14];	// text label pour l'affichage du nb de tuiles jet�e pour le joueur
...
//			oldTilesLabl[nbOldTile].setIcon(discardedTile.donneIcon(true));		
	...
	/**
	 * affiche le nombre de tuile jet�e pour chaque tuile de la mainCache
